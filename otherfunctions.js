...
function zoomIn() {
  ...
  target.style.height = currentHeight * 1.2 + "em";
  target.style.width = currentWidth * 1.2 + "em";
  target.style.transition = "height 200ms ease-in, width 200ms ease-in";

  // Preserve rotation while zooming
...
function mapNavInfo() {
  alert(
    "On a TouchSceenUse 1 finger to Pan, 2 fingers to zoom and 3 fingers to rotate.\n Shortcut Keys: \n Ctrl + --> to rotate 15 degrees clockwise \n Ctrl + <-- to rotate 15 degrees anti clockwise"
  );
}
